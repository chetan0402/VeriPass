...
>
	<div class="flex min-h-0 grow-1 flex-col items-center overflow-y-scroll">
		...
		{/if}
		<div
			class="from-primary-600 to-secondary-600 flex w-svw grow-1 flex-col rounded-t-[20px] bg-gradient-to-r pt-[2px]"
		>
			<div
				class="flex w-svw grow-1 flex-col items-center overflow-x-hidden rounded-t-[20px] bg-white p-4"
			>
				<BorderDiv
	...
	<div class="border-t-primary-800 w-full border-t-1 bg-white px-4 pb-6">
		<div class=" live-time-ticker mb-3 rounded-2xl">
