...
>
    <div class="flex flex-col min-h-0 grow-1 overflow-y-scroll items-center">
        ...
        {/if}
        <div
                class="from-primary-600 to-secondary-600 grow-1 w-svw flex flex-col rounded-t-[20px] bg-gradient-to-r pt-[2px]"
        >
            <div
    ...
    <div class="border-t-primary-800 border-t-1 bg-white w-full px-4 pb-6 ">
